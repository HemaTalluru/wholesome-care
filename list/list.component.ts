...
export class ListComponent implements OnInit {
  ...
  users:any;
  constructor(@Inject(MAT_DIALOG_DATA) private list:any, private _http:HttpClient, private matSnackBar:MatSnackBar, private dialogRef: MatDialogRef<ListComponent>) {}
